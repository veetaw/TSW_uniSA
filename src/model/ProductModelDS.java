...
public class ProductModelDS implements ProductModel {
	...
	/*
	 * Funzione per salvare un vino. Da usare nella parte dell'amministratore quando
	 * inserisce un nuovo vino
	 */
	@Override
	...
	/*
	 * Funzione per ottenere un vino dall'ID Da usare per
	 * acquisti/cancellazioni/visualizzazione dettagli
	 */
	@Override
	 ...
	 * svantaggio un più rapido riempimento del database, ma come vantaggio ci
	 * permette di mantenere uno storico dei prodotti acquistati consistente anche
	 * dopo un'eliminazione.
	 * 
	 * Per evitare spazzatura nel database potrebbe essere utile uno script che
	 * eseguito periodicamente vada a cancellare definitivamente i prodotti con la
	 * flag `eliminato` impostata su true, ma con zero acquisti collegati a esso.
	 */
	@Override
	...
	/*
	 * Funzione per prendere tutti i prodotti presenti nel database con la flag
	 * `eliminato` impostata su false, quindi i prodotti attualmente attivi.
	 * 
